...
const PHOTO_URL = 'https://lh3.googleusercontent.com/gps-cs-s/APNQkAFL5s1OydgdNoqJw1BmdoPWRaozOhb_j_nNtEDmmSZkbWnw_xGgMUPfZDeqnUjqnJT1pHcoITdGXa701fOECx16CdK5YY89uTnxylxcQv5Ng3TTZJtKO4QOPOMHVhp5vm5xXfbEYHPCHGg4=s1360-w1360-h1020-rw'

async function main() {
  const { data: shops } = await supabase.from('dd_shops').select('id, name, address').ilike('name', 'donut express').ilike('address', '%highway 64%')
