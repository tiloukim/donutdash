    ...
    <footer className="dd-footer">
      ...
      <div style={{ maxWidth: '1080px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '1.25rem' }}>
          <Link href="/">
            <span style={{ display: 'inline-flex', alignItems: 'center' }}><img src="/DonutDashfooterlogo.png" alt="DonutDash" className="dd-footer-logo" style={{ width: 'auto', filter: 'brightness(1.1)', display: 'block', margin: '0 auto' }} /><sup style={{ fontSize: 20, fontWeight: 800, marginLeft: 2, position: 'relative', top: 10 }}>™</sup></span>
          </Link>
