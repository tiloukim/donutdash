      ...
      <div className="driver-layout">
        ...
        <aside className="driver-sidebar">
          <div style={{ padding: '24px 20px 16px' }}>
            ...
            <span style={{ display: 'inline-flex', alignItems: 'center' }}><img src="/logo.png" alt="DonutDash" style={{ height: 40, width: 'auto', filter: 'brightness(10)' }} /><sup style={{ fontSize: 20, fontWeight: 800, marginLeft: 2, color: '#fff' }}>™</sup></span>
