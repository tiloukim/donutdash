...
<table class="form">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:center;vertical-align:middle;padding:6px 2px"><div style="line-height:1;letter-spacing:-1px"><span style="font-size:40px;font-weight:300;color:#000;-webkit-text-stroke:0.5px #000">${String(year).slice(0,2)}</span><span style="font-size:48px;font-weight:900;color:#000">${String(year).slice(2)}</span></div></td>
    </tr>
    <tr>
