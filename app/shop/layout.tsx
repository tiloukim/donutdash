  ...
  const sidebar = (
    <>
      <div style={{ padding: '16px 14px 10px' }}>
        <span style={{ display: 'inline-flex', alignItems: 'center' }}><img src="/logo.png" alt="DonutDash" style={{ height: 32, width: 'auto', filter: 'brightness(10)' }} /><sup style={{ fontSize: 11, fontWeight: 700, marginLeft: 1, color: '#fff' }}>™</sup></span>
