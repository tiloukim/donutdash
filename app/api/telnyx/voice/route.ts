...
const BUSINESS_HOURS_START = 5  // 5 AM CT
const BUSINESS_HOURS_END = 22   // 10 PM CT
  ...
  switch (digit) {
    case '1':
      ...
      return texml(`
        ...
        <Say voice="alice" language="en-US">We didn't receive your order number. Returning to the main menu.</Say>
    ...
    case '0':
      ...
      if (!isBusinessHours()) {
        return texml(`
          <Say voice="alice" language="en-US">
            Our office is currently closed. Our business hours are 5 AM to 10 PM Central Time, 7 days a week.
    ...
    default:
      return texml(`
        <Say voice="alice" language="en-US">Invalid selection. Please try again.</Say>
        <Redirect method="POST">https://donutdash.app/api/telnyx/voice</Redirect>
      `)
  }
}
