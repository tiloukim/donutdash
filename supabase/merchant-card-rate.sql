...
-- No updated_at here: dd_shops has no such column, and the Supabase SQL
-- editor runs the whole script in one transaction — so referencing it
-- rolls back the ALTERs above too, leaving the column uncreated.
