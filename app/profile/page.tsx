    ...
    <div style={{ minHeight: '100vh', background: '#F8F9FA' }}>
      ...
      <div style={{ background: '#fff', borderBottom: '1px solid #f0f0f0', padding: '16px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <Link href="/" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 8 }}>
          <span style={{ display: 'inline-flex', alignItems: 'center' }}><img src="/logo.png" alt="DonutDash" style={{ height: 40 }} /><sup style={{ fontSize: 20, fontWeight: 800, marginLeft: 2 }}>™</sup></span>
        </Link>
