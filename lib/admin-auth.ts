...
export const PAGE_ROLES: Record<string, readonly AdminPortalRole[]> = {
  ...
  '/admin/devices':          ['admin', 'general_manager', 'field_manager'],
  ...
  '/admin/sponsorships':     ['admin', 'general_manager'],
  ...
  '/admin/broadcast':        ['admin', 'general_manager', 'marketing_manager'],
...
> = {
  ...
  '/admin/devices':          { label: 'POS Devices',    icon: '🖥️', group: 'ops' },
  ...
  '/admin/sponsorships':     { label: 'Sponsorships',   icon: '⭐', group: 'ops' },
  ...
  '/admin/broadcast':        { label: 'Broadcast',      icon: '📢', group: 'marketing' },
