...
function mainMenu() {
  ...
  return texml(`
    ...
    <Say voice="Telnyx.Ultra.3e1ed423-17e5-4773-b87c-25b031106e41" language="en-US">We didn't receive your selection. Goodbye!</Say>
    <Hangup/>
  `)
}
  ...
  switch (digit) {
    case '1':
      ...
      return texml(`
        ...
        <Say voice="Telnyx.Ultra.3e1ed423-17e5-4773-b87c-25b031106e41" language="en-US">We didn't receive your order number. Returning to the main menu.</Say>
    ...
    default:
      return texml(`
        <Say voice="Telnyx.Ultra.3e1ed423-17e5-4773-b87c-25b031106e41" language="en-US">Invalid selection. Please try again.</Say>
        <Redirect method="POST">https://donutdash.app/api/telnyx/voice</Redirect>
      `)
  }
}
