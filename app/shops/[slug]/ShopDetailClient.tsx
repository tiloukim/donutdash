...
export default function ShopDetailClient({
  ...
  /** Fetched on the server in page.tsx. Seeding state from props is what
   *  makes the shop name, description and menu appear in the server-rendered
   *  HTML — previously everything loaded in useEffect, so a crawler saw only
   *  the loading shell and the site-wide default <title>. */
  ...
  // Already have data from the server — don't flash a spinner over it.
