  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ display: 'inline-flex', alignItems: 'center' }}><img src="/logo.png" alt="DonutDash" style={{ height: '50px', width: 'auto', marginBottom: 8, filter: 'brightness(10)' }} /><sup style={{ fontSize: 10, fontWeight: 800, marginLeft: 1, position: 'relative', top: 5, color: '#fff' }}>™</sup></span>
