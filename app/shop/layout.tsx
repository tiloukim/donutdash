  ...
  const sidebar = (
    <>
      <div style={{ padding: '16px 14px 10px' }}>
        <span style={{ display: 'inline-flex', alignItems: 'center' }}><img src="/logo.png" alt="DonutDash" style={{ height: 32, width: 'auto', filter: 'brightness(10)' }} /><sup style={{ fontSize: 20, fontWeight: 800, marginLeft: 2, position: 'relative', top: 10, color: '#fff' }}>™</sup></span>
